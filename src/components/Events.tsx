...
const events: Event[] = [
  {
    ...
    rules: ["Individual or Team of 2–4 members", "Duration: 2 Hour", "Vibe coding"],
  ...
  },
  {
    ...
    rules: ["Individual or Team of 2–3 members", "Languages: Java, Python", "Duration: 2 Hours"],
  ...
  },
  {
    ...
    rules: ["Individual or Team of 2 members", "Duration: 2 Hours", "Tool: Canva "],
  ...
  },
  {
    ...
    rules: ["Team of 2-4 members", "Buzzer rounds", "Pattern and logic-based challenges"],
